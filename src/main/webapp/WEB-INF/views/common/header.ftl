<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
	<div class="container">
		...
		<#else>
		<div class="row">
			<a href="/cns/signup"><button class="btn btn-secondary mr-3" id="header_signup_btn">Sign Up</button></a>
			<a href="/cns"><button class="btn btn-secondary" id="header_login_btn">Login</button></a>
		</div>
		</#if>
	</div>
</nav>
